...
Bundle::Text::MagicTemplate - A bundle to install Text::MagicTemplate plus all related extensions and prerequisites.
...
This bundle gathers together Text::MagicTemplate and all the related extensions and prerequisites.
