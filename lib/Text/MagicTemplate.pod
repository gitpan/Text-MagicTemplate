...
You can maintain your old code whether adapting it to the new style (very easy job to do), or using an older compatible version (I hate this way :-(). See F<Warning> file in this distribution for details.
...
The I<attributes string> contains every character between the end of the label I<identifier> and the END_LABEL marker. This is optionally used to pass special parameters to the behaviour.
